...
const mockEtapas = [
  {
    id: 1,
    nome: "Colocar mola",
    dados: ["Prazo: 12/05/2026", "Status: Concluída", "Funcionários: Cauã | Davi", "Aeronave: Aeronave 1"],
  },
  {
    id: 2,
    nome: "Acoplar janelas",
    dados: ["Prazo: 28/11/2026", "Status: Em Andamento", "Funcionários: Davi", "Aeronave: Aeronave 2"],
  },
  {
    id: 3,
    nome: "Apresentar aeronave",
    dados: ["Prazo: 12/07/2027", "Status: Cancelada", "Funcionários: Davi | João", "Aeronave: Aeronave 3"],
  },
];
